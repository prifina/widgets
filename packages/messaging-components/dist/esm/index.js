                  ...
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      ...
                      */
                      ...
                      filter = _defineProperty({}, "chatId", _defineProperty({}, Op.eq, receiver.chatId));
                      _context3.next = 7;
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      ...
                      filter = _defineProperty({}, Op.and, (_Op$and = {}, _defineProperty(_Op$and, "receiver", _defineProperty({}, Op.eq, receiver.chatId)), _defineProperty(_Op$and, "sender", _defineProperty({}, Op.eq, get().APIcurrentUser.uuid)), _Op$and));
                      /*
                          const filter = {
                            [Op.and]: {
                              [year]: {
...
var ChatMessage = function ChatMessage(props, ref) {
  ...
  if (props.chat === props.contents.chatId || props.contents.sender === props.chat && props.contents.receiver === props.user.uuid || props.contents.receiver === props.chat && props.contents.sender === props.user.uuid) {
    return /*#__PURE__*/React.createElement(Message, _extends({}, props, {
      ref: ref
    }));
  } else {
    return null;
...
var ChatMessage$1 = /*#__PURE__*/forwardRef(ChatMessage);
...
function Chat(_ref) {
  ...
  */
  ...
  return /*#__PURE__*/React.createElement(ChatContainer, {
    ...
    className: "chat__nav"
  }, mode === 3 && /*#__PURE__*/React.createElement(IconButton, {
    onClick: changeMode
...
var Form$1 = styled(SidebarChat)(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  .sidebarChat {\n    display: flex;\n    align-items: center;\n    padding: 20px;\n    border-bottom: 1px solid lightgray;\n    cursor: pointer;\n  }\n\n  .sidebarChat:hover {\n    background-color: #3e93fd;\n    color: white;\n  }\n\n  .sidebarChat__info {\n    margin-left: 15px;\n    position: relative;\n    width: 100%;\n  }\n\n  .sidebarChat__info > small {\n    position: absolute;\n    top: 5px;\n    right: 0;\n  }\n"])));
...
var SideContainer = styled.div(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  /* */\n  width: ", ";\n"])), function (props) {
  return props.width;
});
var Form = styled(Sidebar)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  .sidebar {\n    flex: 0.35;\n    /* height: 100vh; */\n    height:100%;\n    display: flex;\n    flex-direction: column;\n    background-color: #f5f5f5;\n    border-right: 1px solid lightgray;\n  }\n\n  .sidebar__header {\n    display: flex;\n    align-items: center;\n    padding: 10px;\n    height: 50px;\n  }\n\n  .sidebar__avatar {\n    cursor: pointer;\n    margin: 10px;\n  }\n\n  .sidebar__input {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    flex: 1;\n    background-color: #e1e1e1;\n    color: gray;\n    border-radius: 5px;\n  }\n\n  .sidebar__input > input {\n    border: none;\n    background: transparent;\n    outline-width: 0;\n  }\n\n  .sidebar__chats {\n    overflow: scroll;\n  }\n\n  /* Hide scrollbar for Chrome, Safari and Opera */\n  .sidebar__chats::-webkit-scrollbar {\n    display: none;\n  }\n\n  /* Hide scrollbar for IE, Edge and Firefox */\n  .sidebar__chats {\n    -ms-overflow-style: none; /* IE and Edge */\n    scrollbar-width: none; /* Firefox */\n  }\n"])));
...
function Sidebar(_ref) {
  ...
  */
  ...
  return /*#__PURE__*/React.createElement(SideContainer, {
    width: mode === 1 ? "40%" : "100%"
  }, /*#__PURE__*/React.createElement("div", {
    className: className
  }, /*#__PURE__*/React.createElement("div", {
...
var AppContainer = styled.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  /* */\n  display: flex;\n  height:100%;\n"])));
...
var IMessage = function IMessage(props) {
  ...
  var initRef = useRef(false); // const datamodels = [];
  // init();
  ...
  */
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !loading && /*#__PURE__*/React.createElement(AppContainer, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
    onClick: addMsg
  }, "New Message"), /*#__PURE__*/React.createElement("button", {
    onClick: addMsg2
  }, "New Message2")), (mode === 1 || mode === 2) && /*#__PURE__*/React.createElement(Form, null), (mode === 1 || mode === 3) && /*#__PURE__*/React.createElement(Form$2, {
    newChats: newChats
  })), loading && /*#__PURE__*/React.createElement("div", null, "Loading"));
};

IMessage.displayName = "IMessage";
export { IMessage, StoreProvider, useStore };
